...
const Navbar = ({
  ...
  return <header className={cn('sticky top-0 z-50 w-full transition-all duration-300 ease-in-out', scrolled ? 'glass border-b border-border/40 py-3' : 'bg-transparent py-5')}>
